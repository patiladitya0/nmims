...
const MyAccount = () => {
    ...
    const handlePasswordUpdate = async (e) => {
        ...
        try {
            ...
            const response = await axios.put('https://cap-server-1.onrender.com/api/user/update-password', { currentPassword, newPassword }, config); // Replace with your actual endpoint
